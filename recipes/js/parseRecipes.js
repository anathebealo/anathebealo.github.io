...
function makeThumbnail(name_of_file) {
	...
	jQuery.get("txtRecipes/setup.txt", function(data) {
		...
		var sidebar_list = "<div id='sidebar_container'><button id='sidebar_butt' onclick='location.href=\"https://anathebealo.github.io/recipes/recipe_tags.html\"'>All Recipes</button>";
		var onclick = "";
