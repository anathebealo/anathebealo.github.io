...
function draw_all_tag_thumbnails() {
	...
	for( var recipe in recipes){
		tag_list += "<div class='tag_thumbnail' onclick='location.href=\"https://anathebealo.github.io/recipes/recipes.html?" + recipe + "\"'>";
	...
	for (var tag_name in tags) {
	  	if (tags.hasOwnProperty(tag_name)) {
		  	...
		  	for(var c = 0; c<tags[tag_name].length; c++) {
				...
				tag_list += "<div class='tag_thumbnail' onclick='location.href=\"https://anathebealo.github.io/recipes/recipes.html?" + recipe_base + "\"'>";
